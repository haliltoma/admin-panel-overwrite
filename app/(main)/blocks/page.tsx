        ...
        <>
            <BlockViewer header="Hero" code={block1} free>
                <div className="grid grid-nogutter surface-0 text-800">
                    ...
                    <div className="col-12 md:col-6 overflow-hidden">
                        <img src="/demo/images/blocks/hero/hero-1.png" alt="hero-1"
            ...
            <BlockViewer header="Feature" code={block2} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0 text-center">
                    ...
                    <div className="text-700 mb-6">Ac turpis egestas maecenas pharetra convallis posuere morbi leo
                        urna.
                    </div>
                    <div className="grid">
                        <div className="col-12 md:col-4 mb-4 px-5">
            ...
            <BlockViewer header="Pricing" code={block3} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0">
                    <div className="text-900 font-bold text-6xl mb-4 text-center">Pricing Plans</div>
                    <div className="text-700 text-xl mb-6 text-center line-height-3">Lorem ipsum dolor sit, amet
                        consectetur adipisicing elit. Velit numquam eligendi quos.
                    </div>
            ...
            <BlockViewer header="Call to Action" code={block4} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8"
                ...
                <div className="surface-0 text-700 text-center">
                    ...
                    <div className="text-900 font-bold text-5xl mb-3">Join Our Design Community</div>
                    <div className="text-700 text-2xl mb-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                ...
                <div className="flex align-items-center justify-content-center">
                    <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
                        ...
                        <div>
                            ...
                            <div className="flex align-items-center justify-content-between mb-6">
                                <div className="flex align-items-center">
                                    <Checkbox id="rememberme" onChange={(e) => setChecked(e.checked as boolean)}
            ...
            <BlockViewer header="Description List" code={block9}
                         containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0">
                    <div className="font-medium text-3xl text-900 mb-3">Movie Information</div>
                    ...
                    <ul className="list-none p-0 m-0">
                        ...
                        <li className="flex align-items-center py-3 px-2 border-top-1 border-bottom-1 border-300 flex-wrap">
                            <div className="text-500 w-6 md:w-2 font-medium">Plot</div>
                            <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1 line-height-3">A group
                                of professional bank robbers start to feel the heat from police when they unknowingly
            ...
            <BlockViewer header="Card" code={block10} containerClassName="px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0 p-4 shadow-2 border-round">
                    <div className="text-3xl font-medium text-900 mb-3">Card Title</div>
                    <div className="font-medium text-500 mb-3">Vivamus id nisl interdum, blandit augue sit amet,
                        eleifend mi.
                    </div>
                    <div style={{ height: '150px' }} className="border-2 border-dashed border-300"></div>
                </div>
